...
function SYES() {
  $(".YESNO").fadeOut(1500, function() {
    ...
    $("#BTNADD").html("Add <strong>" + WANTED + " free TikTok Followers </strong>")
    $("#BTNADD").fadeIn(1500);
  })
}
...
function SADDB() {
  ...
  $("#step34").html("<strong>Step 3:</strong> Adding your <strong>free TikTok Followers </strong>!")
  ...
  setTimeout(function() {
    var FOL = new CountUp('acc777', 0, parseInt(WANTED), 0, 18, options);
        ...
        setTimeout(function() {
          $("#CONS").html("Disconnecting from <strong>TikTok Followers  servers</strong>...")
        }, 14000)
  }, 1500)
